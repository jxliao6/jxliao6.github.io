...
- **Full-stack and Design**: Developed scalable full-stack Web systems using React, JavaScript, and D3.js (frontend), and NoSQL, Python (backend) which increased interactions and improved click rates by 2x
...
- **Data**: Developed credit score assessment which boosted default risk prediction accuracy by 4% and increased data size by 26% and now employed by underwriters to refine underwriting process
